...
[CrowPanel-Advanced-7inch-ESP32-P4-HMI-AI-Display-1024x600-IPS-Touch-Screen/example/V1.2/AI_Conversation at master · Elecrow-RD/CrowPanel-Advanced-7inch-ESP32-P4-HMI-AI-Display-1024x600-IPS-Touch-Screen](https://github.com/Elecrow-RD/CrowPanel-Advanced-7inch-ESP32-P4-HMI-AI-Display-1024x600-IPS-Touch-Screen/tree/master/example/V1.2/AI_Conversation)

5-inch-V1.0:

[-CrowPanel-Advanced-5inch-ESP32-P4-HMI-AI-Display-800x480-IPS-Touch-Screen/example/V1.0/AI_Conversation at master · Elecrow-RD/-CrowPanel-Advanced-5inch-ESP32-P4-HMI-AI-Display-800x480-IPS-Touch-Screen](https://github.com/Elecrow-RD/-CrowPanel-Advanced-5inch-ESP32-P4-HMI-AI-Display-800x480-IPS-Touch-Screen/tree/master/example/V1.0/AI_Conversation)
...
##### 2. Se  lect the folder you want to open, click “Select Folder” to open the project. Be careful not to double-click to open it.
...
> Now, the Wi-Fi configuration here has been replaced with macro definitions. You don't need to change each one individually
>
> —**just replace the Wi-Fi username and password macros** at the beginning of this file with your own credentials.
>
> Open **main->boards->elecrow-p4-board->config.h**   (The latest code has optimized the code, so the path has also been modified.)
...
> Select the COM port that suits you.
